        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 pb-6 border-b border-[#242624]/15">
          ...
          <FadeIn direction="up" delay={0.1}>
            <p className="text-xs sm:text-sm font-light text-[#242624]/70 max-w-xs leading-relaxed">
              Fotografía real de actividades y renders arquitectónicos que traducen la atmósfera y materialidad de Espacio Río.
            </p>
          </FadeIn>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          ...
          {galleryData[0] && (
            <div className="md:col-span-12">
              <FadeIn direction="up">
                <div className="relative aspect-[21/9] w-full overflow-hidden bg-[#D8D3C8] group shadow-sm">
                  <Image
          ...
          {galleryData[1] && (
            <div className="md:col-span-5">
              <FadeIn direction="up" delay={0.1}>
                <div className="relative aspect-[4/5] w-full overflow-hidden bg-[#D8D3C8] group shadow-sm">
                  <Image
          ...
          {galleryData[2] && (
            <div className="md:col-span-7">
              <FadeIn direction="up" delay={0.2}>
                <div className="relative aspect-[16/11] w-full overflow-hidden bg-[#D8D3C8] group shadow-sm">
                  <Image
              ...
              <FadeIn direction="up" delay={0.1}>
                <div className="relative aspect-[16/11] w-full overflow-hidden bg-[#D8D3C8] group shadow-sm">
                  ...
                  <div className="absolute top-4 left-4 z-10">
                    <span className="bg-[#080A0D]/90 text-[#FFE9A3] text-[9px] font-bold tracking-widest px-2.5 py-1 rounded-full uppercase border border-[#FFE9A3]/30">
                      ✦ FOTO REAL
                    </span>
                  </div>
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
